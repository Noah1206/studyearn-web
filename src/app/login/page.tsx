            ...
            >
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-4 px-6 bg-[#FEE500] hover:bg-[#FDD835] text-[#191919] font-semibold rounded-xl transition-all"
                >
              ...
              <form onSubmit={handleEmailLogin} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3.5 text-gray-900 border border-gray-300 rounded-xl focus:border-gray-900 focus:ring-1 focus:ring-gray-900 focus:outline-none transition-colors"
                    autoFocus
                  />
                </div>
                <div>
                ...
                <button
                  ...
                  className="w-full py-4 px-6 bg-gray-900 hover:bg-gray-800 disabled:bg-gray-300 text-white font-semibold rounded-xl transition-all mt-6"
                >
                  {isLoading ? (
              ...
              <form onSubmit={handlePhoneLogin} className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="bg-gray-100 px-4 py-3.5 rounded-xl">
                    ...
                    <input
                      ...
                      maxLength={13}
                      className="flex-1 px-4 py-3.5 text-gray-900 border border-gray-300 rounded-xl focus:border-gray-900 focus:ring-1 focus:ring-gray-900 focus:outline-none transition-colors"
                      autoFocus
                    />
                  </div>
                </div>
