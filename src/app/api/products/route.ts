  ...
  try {
    ...
    const productsWithCreator = (contents || []).map((content: {
      ...
      return {
        ...
        creator: {
          name: profile?.nickname || (creatorSettings?.display_name && !creatorSettings.display_name.includes('@') ? creatorSettings.display_name : null) || (content.creator_id ? authNamesMap[content.creator_id] : null) || '익명',
